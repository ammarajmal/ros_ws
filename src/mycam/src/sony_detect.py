...
class ArucoDetector:
    def __init__(self):
        # Initialize ROS node
        rospy.init_node('sony_aruco_detector', anonymous=True)

        # Initialize ROS subscriber for camera images
        rospy.Subscriber('/sony_1/image_raw', Image, self.image_callback)
        ...
        self.marker_pub = rospy.Publisher('~image_raw', Image, queue_size=10)
