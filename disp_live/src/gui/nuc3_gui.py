...
class ClientGUI(customtkinter.CTk):
    ...
    def __init__(self)-> None:
        ...
        # self.left_top_frame_nuc3_cam_button = customtkinter.CTkButton(self.left_top_frame)
    ...
    def _create_left_top_frame_content(self)-> None:
        ...
        self.left_top_frame_nuc3_cam_button = customtkinter.CTkButton(
        ...
        self.left_top_frame_nuc3_cam_button.place(relx=0.5, rely=0.25, anchor="center")
    ...
    def _start_cam_1_button_event(self, camera_number, show_camera, calibrate_camera) -> None:
        ...
        cameras = [
        {'camera_name': 'nuc3_camera',
         'device_id': 0,
         'calibration_file': 'nuc3_cam',
         'button': self.left_top_frame_nuc3_cam_button,
        ...
        camera_active_states = [self.nuc3_camera_active,
        ...
        self.nuc3_camera_active, self.camera_2_active, self.camera_3_active = camera_active_states
    def start_camera(self, camera_name, device_id, calibration_file, view_camera, calibrate_camera) -> None:
        ...
        try:
            ...
            if camera_name == 'nuc3_camera':
                self.nuc3_camera_active = True
    ...
    def _view_camera_checkbox_event(self) -> None:
        ...
        if self.view_camera.get():
            self.left_top_frame_nuc3_cam_button.configure(text="View Camera 1", fg_color=themes[COLOR_SELECT][0])
        else:
            self.left_top_frame_nuc3_cam_button.configure(text="Start Camera 1",
                                                            fg_color=themes[COLOR_SELECT][1])
